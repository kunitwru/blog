    ...
    return (
      ...
      <form className="form-horizontal" autoComplete="false" onSubmit={(e) => this.onSubmit(e)}>
        ...
        <div className="row" style={{paddingTop: '1rem'}}>
          ...
          <div className="col-md-6">
            <center>
                <button type="submit" className="btn btn-success" style={{marginRight:10}}><i className="fa fa-sign-in" /> Đăng nhập</button>
                <Link to="/dang-ky" className="btn btn-primary"><i className="fa fa-user"></i> Đăng ký</Link>
              <br />
